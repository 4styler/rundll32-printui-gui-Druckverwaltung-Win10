...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid>
        ...
        <Button x:Name="b6" Content="Geräte und Drucker Alt" HorizontalAlignment="Left" Margin="315,13,0,0" VerticalAlignment="Top" Width="162" Height="23"/>
...
$var.b3.add_Click({
    if ($var.lb1.SelectedItem -or $var.lb2.SelectedItem){
        ...
        if ($var.lb2.SelectedItem){
            rundll32 printui.dll,PrintUIEntry /in /n "$($var.lb2.SelectedItem)"
            $id = $(Get-Process rundll32).Id
            Wait-Process $id
